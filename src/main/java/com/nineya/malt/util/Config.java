...
public class Config {
    ...
    public static void init(Configuration configuration){
        Log.info(Console.getLineNum("malt", "正在载入配置..."));
        config = new Config();
        ...
        Log.info(Console.getLineNum("malt", "配置信息载入成功！"));
    }
    ...
    public static void init(String path){
        Log.info(Console.getLineNum("malt", "读取配置文件中..."));
    ...
    public static void  init(){
        Log.info(Console.getLineNum("malt", "加载默认配置中..."));
